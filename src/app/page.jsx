...
export default function Home() {
  ...
  return (
    <main>
      <section className="min-h-screen bg-[#001C34] flex flex-col md:flex-row  items-center gap-x-8 px-4 md:px-44 relative z-10 py-16 md:py-0">
      ...
      <section className="min-h-screen bg-[#F0F0F0] px-4 md:px-0">
        <div className="flex flex-col items-center justify-center pt-8 md:pt-16">
          <h1 className="text-[#B80104] font-bold text-2xl text-center md:text-start">
            Confira o Bonanza Fly-in em matéria do programa AutoEsporte na
            GloboPlay
          </h1>
          ...
          <div className="mt-12 md:mt-44">
            <h1 className="uppercase text-3xl md:text-5xl text-center font-bold text-[#002C52] md:leading-14 max-w-4xl">
              <span className="text-[#B80104]">grandes marcas</span>{" "}
              <span>que vão fazer esse encontro acontecer</span>
            </h1>
          </div>
          <div className="mt-12 mb-8 flex gap-x-4 items-center">
            <div className="border border-[#787878] w-[200px] "></div>
            <GiCommercialAirplane color="black" size={36} />
            <div className="border border-[#787878] w-[200px] "></div>
          </div>
